      ...
      body: SafeArea(
        child: Stack(
          children: [
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: state.participants.map((p) {
                            ...
                            return Padding(
                              padding: EdgeInsets.symmetric(
                                horizontal: Responsive.w(AppDimens.paddingS),
                              ),
                              child: ParticipantAvatar(
                                participant: p,
                                size: Responsive.w(
                                  AppDimens.avatarSize,
                                ), // Scale avatar
                              ),
                            );
                          }).toList(),
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: AnimUtils.slideUpFade(
                        ...
                        child: Padding(
                          padding: EdgeInsets.symmetric(
                            horizontal: Responsive.w(AppDimens.paddingL),
                          ),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              ...
                              if (provider.selectedUnitIds.isNotEmpty) ...[
                                PrimaryButton(
                                  label:
                                      '${AppStrings.btnSubmit} (${provider.selectedUnitIds.length})',
                              ...
                              if (state.lastActionText != null &&
                                  state.activeParticipantId == 'me') ...[
                                SizedBox(
                                  width: Responsive.w(AppDimens.paddingM),
                                ),
                                PrimaryButton(
            ...
            if (_flyingUnits.isNotEmpty) ..._buildFlyingUnits(),
          ],
        ),
      ),
    );
  ...
  Widget _buildFan(
    ...
    return Stack(
      children: List.generate(count, (index) {
        ...
        final double left =
            (Responsive.screenWidth / 2) -
            (Responsive.w(AppDimens.cardWidth) / 2) +
            offsetX;
        final double bottom =
            Responsive.h(40) - offsetY + (isSelected ? Responsive.h(40) : 0);
  ...
  List<Widget> _buildFlyingUnits() {
    ...
    return _flyingUnits.map((unit) {
      ...
      final double startTop =
          ...
          Responsive.h(40) -
          startBottom -
          Responsive.h(AppDimens.cardHeight);

      final double targetTop =
          _pilePosition.dy - (Responsive.h(AppDimens.cardHeight) / 2);
      final double targetLeft =
          _pilePosition.dx - (Responsive.w(AppDimens.cardWidth) / 2);
      ...
      return AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          final currentRotation = lerpDouble(rotation, math.pi, curveVal) ?? 0;
