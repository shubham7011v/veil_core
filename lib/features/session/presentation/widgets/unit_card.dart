...
class UnitCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color suitColor = highlightError
        ? Colors.red
        : _getSuitColor(unit.type);
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isSelected
                        ...
                        : (highlightError ? Colors.red : Colors.black12),
                    width: (isSelected || highlightError) ? 2 : 0.5,
                  ),
                ),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(10),
                  child: Stack(
                    children: [
                      ...
                      // Back side if not revealed and not mine (though usually mine is shown)
                      if (!isRevealed &&
                          !isSelected &&
                          unit.id.startsWith('bot_'))
